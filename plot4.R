...
## @@@@@ Assignment task 04 - Four plots
  ...
  # Addng legends - as this is cluttering the chart
  legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, lwd = 1, bty = "n", cex = 0.5, col = c("black", "red", "blue"))
