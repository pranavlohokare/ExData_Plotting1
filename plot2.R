...
## March 23, 2020
 ...
 #
 # To create plot 02 as required (details stored locally and on GitHub)
 #
 ##
...
## @@@@@ Assignment task 02 - Global Active Power plot
  ...
  dev.copy(png, width = 480, height = 480, file = "./Outputs/plot2.png")
  dev.off()
